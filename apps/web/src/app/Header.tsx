  ...
  return (
    <nav style={{ width: "100%", background: "var(--primary)", color: "var(--primary-foreground)", padding: "12px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", position: "fixed", top: 0, zIndex: 10 }}>
      <div style={{ display: "flex", alignItems: "center", gap: "24px" }}>
        ...
        <a href="/blog" style={{ color: "var(--primary-foreground)", fontSize: "0.95rem", fontWeight: 600, textDecoration: "none", display: "flex", alignItems: "center", gap: "6px" }}>
          <span style={{ fontSize: "1.1rem" }}>📝</span>
          Blog
        </a>
        <a href="tel:5551234567" style={{ color: "var(--primary-foreground)", fontSize: "0.95rem", fontWeight: 600, textDecoration: "none", display: "flex", alignItems: "center", gap: "6px" }}>
          <span style={{ fontSize: "1.1rem" }}>📞</span>
          (555) 123-4567
        </a>
      </div>
