...
export default function Home() {
  return (
    <main>
      <Header />
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "0 24px", background: "var(--phone)", color: "white" }}>
        <h2 style={{ fontSize: "3rem", fontWeight: "bold", marginBottom: "16px", color: "white" }}>Welcome to Test Firm</h2>
        <p style={{ fontSize: "1.25rem", color: "white", maxWidth: "600px", marginBottom: "32px" }}>Your trusted partner for professional services</p>
